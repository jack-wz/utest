...
def run_tests():
    ...
    try:
        print("\n===== STARTING ENTERPRISE API TESTS =====")
        test_instance.test_01_api_root()
        test_instance.test_02_system_info()
        test_instance.test_03_vector_db_health()
        test_instance.test_04_file_upload()
        test_instance.test_05_feishu_connector()
        test_instance.test_06_wechat_work_connector()
        test_instance.test_07_llm_model()
        test_instance.test_08_vision_model()
        test_instance.test_09_embedding_model()
        test_instance.test_10_vector_db_connection()
        test_instance.test_11_batch_upload()
        test_instance.test_12_create_enterprise_workflow()
        test_instance.test_13_get_workflows()
        test_instance.test_14_get_workflow()
        test_instance.test_15_execute_enterprise_workflow()
        test_instance.test_16_get_execution_status()
        test_instance.test_17_nonexistent_workflow()
        test_instance.test_18_nonexistent_execution()
        print("\n===== ALL ENTERPRISE API TESTS COMPLETED =====")
    finally:
